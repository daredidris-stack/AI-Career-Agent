  ...
  return (
    <main className="min-h-screen bg-gray-950 px-6 py-12 text-gray-300">
      <article className="mx-auto max-w-3xl space-y-7 rounded-3xl border border-gray-800 bg-gray-900 p-8 md:p-12">
        ...
        <section><h2 className="text-xl font-semibold text-white">Your choices</h2><p className="mt-2 leading-7">Settings lets you download a portable copy of stored data and permanently delete your account. Saved-search email alerts are off by default, require an explicit choice, and can be disabled in Job Library or through the link in each alert. Depending on location, you may also have rights to access, correct, restrict, object, or complain to a regulator.</p></section>
